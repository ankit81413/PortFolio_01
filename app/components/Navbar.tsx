export function Navbar() {
  return (
    <>
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-x-0 top-0 z-40 h-[100px] bg-white/55 backdrop-blur-xl"
        style={{
          WebkitMaskImage:
      ...
      <nav className="fixed left-1/2 top-4 z-50 flex w-[calc(100%-2rem)] max-w-[1880px] -translate-x-1/2 items-center justify-between rounded-xl border border-black/10 bg-white/82 px-0 py-3 shadow-[0_10px_30px_-20px_rgba(0,0,0,0.35)] backdrop-blur-xl md:top-7 md:w-[calc(100%-3.5rem)] md:px-5 md:py-3">
